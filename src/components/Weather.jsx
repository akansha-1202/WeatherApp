...
function Weather() {
      ...
      return (
            <div className="w-full bg-gradient-to-b from-[#2493DF] from-10% to-[#A2ABBA] grid place-items-center py-8">
              {/* center box */}
                <div className="w-[60%] border-2 border-white rounded-lg shadow-md shadow-white px-4 py-8 flex flex-col justify-between">
                    {/* search box */}
